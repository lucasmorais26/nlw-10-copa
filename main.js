function createGame(player1, hour, player2) {
  ...
  <li>
      ...
      <!--src aonde está a imagem, alt é uma alternativa caso não encontre a imagem ou
      para acessibilidae ou padra leitores de busca, como o Google-->
      <strong>${hour}</strong>
...
document.querySelector("#cards").innerHTML =
  ...
  createCard(
    ...
    createGame("morroco", "07:00", "croatia") +
      ...
      createGame("spanish", "13:00", "costarica") +
  ...
  createCard(
    ...
    createGame("japan", "07:00", "costarica") +
      ...
      createGame("spanish", "16:00", "germany")
  ) +
  createCard(
    "28/11",
    "segunda",
  ...
  createCard(
    ...
    createGame("croatia", "12:00", "belgium") +
      ...
      createGame("japan", "16:00", "spanish") +
  ...
  createCard(
    ...
    createGame("korea", "12:00", "portugal") +
      ...
      createGame("camaron", "16:00", "brazil")
  )
